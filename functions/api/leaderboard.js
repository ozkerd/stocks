...
const ASSET_UNIVERSE = [
  ...
  { symbol: "TAO-USD", display_symbol: "TAO", name: "Bittensor USD", type: "Crypto", exchange: "Crypto", base_price: 485.0, base_return: 32.0, conviction: 90, rating: "STRONG BUY", cap: "mid_cap", tech_score: 92, pa_score: 91 },
  ...
  { symbol: "SUI20947-USD", display_symbol: "SUI", name: "Sui Network USD", type: "Crypto", exchange: "Crypto", base_price: 3.47, base_return: 33.0, conviction: 89, rating: "BUY", cap: "mid_cap", tech_score: 92, pa_score: 93 },
  { symbol: "NEAR-USD", display_symbol: "NEAR", name: "NEAR Protocol USD", type: "Crypto", exchange: "Crypto", base_price: 5.40, base_return: 30.5, conviction: 89, rating: "BUY", cap: "mid_cap", tech_score: 89, pa_score: 91 },
  { symbol: "ONDO-USD", display_symbol: "ONDO", name: "Ondo Finance RWA USD", type: "Crypto", exchange: "Crypto", base_price: 0.98, base_return: 34.0, conviction: 89, rating: "BUY", cap: "low_cap", tech_score: 90, pa_score: 92 },
  { symbol: "AAVE-USD", display_symbol: "AAVE", name: "Aave USD", type: "Crypto", exchange: "Crypto", base_price: 195.0, base_return: 26.5, conviction: 89, rating: "BUY", cap: "mid_cap", tech_score: 90, pa_score: 91 },
  ...
  { symbol: "ASTS", display_symbol: "ASTS", name: "AST SpaceMobile Inc.", type: "Stock", exchange: "NASDAQ", base_price: 24.80, base_return: 38.0, conviction: 88, rating: "BUY", cap: "low_cap", tech_score: 91, pa_score: 92 },
  { symbol: "RKLB", display_symbol: "RKLB", name: "Rocket Lab USA Inc.", type: "Stock", exchange: "NASDAQ", base_price: 18.60, base_return: 32.0, conviction: 88, rating: "BUY", cap: "low_cap", tech_score: 90, pa_score: 91 },
  { symbol: "FET-USD", display_symbol: "FET", name: "Artificial Superintelligence Alliance", type: "Crypto", exchange: "Crypto", base_price: 1.35, base_return: 33.5, conviction: 88, rating: "BUY", cap: "low_cap", tech_score: 87, pa_score: 89 },
  { symbol: "RENDER-USD", display_symbol: "RENDER", name: "Render Network USD", type: "Crypto", exchange: "Crypto", base_price: 5.80, base_return: 31.0, conviction: 88, rating: "BUY", cap: "mid_cap", tech_score: 88, pa_score: 89 },
  { symbol: "INJ-USD", display_symbol: "INJ", name: "Injective USD", type: "Crypto", exchange: "Crypto", base_price: 19.40, base_return: 29.5, conviction: 88, rating: "BUY", cap: "mid_cap", tech_score: 89, pa_score: 90 },
  { symbol: "LIT6833-USD", display_symbol: "LIT", name: "Litentry USD", type: "Crypto", exchange: "Crypto", base_price: 0.118, base_return: 32.0, conviction: 88, rating: "BUY", cap: "low_cap", tech_score: 89, pa_score: 86 },
  ...
  { symbol: "SMCI", display_symbol: "SMCI", name: "Super Micro Computer", type: "Stock", exchange: "NASDAQ", base_price: 42.50, base_return: 36.0, conviction: 87, rating: "BUY", cap: "mid_cap", tech_score: 86, pa_score: 88 },
  { symbol: "APT21794-USD", display_symbol: "APT", name: "Aptos USD", type: "Crypto", exchange: "Crypto", base_price: 8.60, base_return: 28.0, conviction: 87, rating: "BUY", cap: "mid_cap", tech_score: 86, pa_score: 88 },
  { symbol: "JUP-USD", display_symbol: "JUP", name: "Jupiter DEX USD", type: "Crypto", exchange: "Crypto", base_price: 0.85, base_return: 32.0, conviction: 87, rating: "BUY", cap: "low_cap", tech_score: 87, pa_score: 89 },
  { symbol: "IONQ", display_symbol: "IONQ", name: "IonQ Inc. (Quantum)", type: "Stock", exchange: "NYSE", base_price: 28.40, base_return: 35.0, conviction: 86, rating: "BUY", cap: "low_cap", tech_score: 88, pa_score: 87 },
  { symbol: "SEI-USD", display_symbol: "SEI", name: "Sei Network USD", type: "Crypto", exchange: "Crypto", base_price: 0.42, base_return: 35.0, conviction: 86, rating: "BUY", cap: "low_cap", tech_score: 88, pa_score: 87 },
  ...
  { symbol: "ENA-USD", display_symbol: "ENA", name: "Ethena USD", type: "Crypto", exchange: "Crypto", base_price: 0.48, base_return: 36.0, conviction: 86, rating: "BUY", cap: "low_cap", tech_score: 85, pa_score: 87 },
  { symbol: "TIA-USD", display_symbol: "TIA", name: "Celestia USD", type: "Crypto", exchange: "Crypto", base_price: 5.10, base_return: 31.0, conviction: 85, rating: "BUY", cap: "low_cap", tech_score: 84, pa_score: 86 },
...
export async function onRequest(context) {
  ...
  const ranked = filtered.map((item, index) => {
    ...
    const entry_low = Number((item.base_price * 0.985).toFixed(2));
    const entry_high = Number((item.base_price * 1.005).toFixed(2));
    const stop_loss = Number((item.base_price * 0.95).toFixed(2));
    const potential_gain = target_price - item.base_price;
    const potential_risk = Math.max(0.01, item.base_price - stop_loss);
    ...
    return {
      ...
      entry_zone: "$" + entry_low.toLocaleString() + " - $" + entry_high.toLocaleString(),
      target_sell: "$" + target_price.toLocaleString(),
